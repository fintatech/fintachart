...
| 17 | [Overlay Indicator with Own Axis](html/17-overlay-indicator-with-own-axis/) | Overlay — derived series on price pane, auto-scaled to its own left y-axis via `chart.addVerticalScale()` + `Indicator.bindToVerticalScale()` |
